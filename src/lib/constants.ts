...
export const BRANDS = [
  {
    name: "ASUS",
    logo: "/brands/asus-vector-logo-seeklogo/asus-seeklogo.png",
    description: "Innovation First",
    category: "laptop",
  },
  {
    name: "Acer",
    logo: "/brands/acer-vector-logo-seeklogo/acer-seeklogo.png",
    description: "Explore Beyond Limits",
    category: "laptop",
  },
  {
    name: "HP",
    logo: "/brands/hp-vector-logo-seeklogo/hewlett-packard-hp-seeklogo.png",
    description: "Keep Reinventing",
    category: "laptop",
  },
  {
    name: "Lenovo",
    logo: "/brands/lenovo-vector-logo-seeklogo/lenovo-seeklogo.png",
    description: "Smarter Technology",
    category: "laptop",
  },
  {
    name: "MSI",
    logo: "/brands/msi-vector-logo-seeklogo/msi-seeklogo.png",
    description: "True Gaming",
    category: "gaming",
  },
  {
    name: "Dell",
    logo: "/brands/dell-vector-logo-seeklogo/dell-seeklogo.png",
    description: "Trusted Performance",
    category: "laptop",
  },
  {
    name: "Apple",
    logo: "/brands/apple-vector-logo-seeklogo/apple-seeklogo.svg",
